...
export const Login: React.FC = () => {
  ...
  // Demo credentials
  const demoLogin = (role: 'consumer' | 'prosumer' | 'both') => {
    const demoCredentials = {
      consumer: { email: 'demo@consumer.com', password: 'demo123' },
      prosumer: { email: 'demo@prosumer.com', password: 'demo123' },
      both: { email: 'demo@both.com', password: 'demo123' },
    };
